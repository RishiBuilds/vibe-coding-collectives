...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-lg border-3 border-border bg-clip-padding text-sm font-bold whitespace-nowrap transition-all outline-none select-none shadow-[4px_4px_0_0_#0a0a0a] focus-visible:ring-2 focus-visible:ring-ring/70 active:not-aria-[haspopup]:translate-x-[2px] active:not-aria-[haspopup]:translate-y-[2px] active:not-aria-[haspopup]:shadow-none disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-2 aria-invalid:ring-destructive/30 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default: 'bg-primary text-primary-foreground [a]:hover:bg-primary/90',
        outline:
          'bg-background text-foreground hover:bg-secondary aria-expanded:bg-secondary aria-expanded:text-foreground',
        secondary:
        ...
        ghost:
          'border-transparent bg-transparent shadow-none hover:bg-muted hover:shadow-[4px_4px_0_0_#0a0a0a] aria-expanded:bg-muted aria-expanded:text-foreground',
        destructive:
